...
export type Schemas = (JSONSchema6 | JSONSchema7) & {
...
// 使用as const声明FieldPropsDefine是readonly类型
...
// 定义provide的context类型
export type SchemaItemDefine = DefineComponent<typeof FieldPropsDefine>
