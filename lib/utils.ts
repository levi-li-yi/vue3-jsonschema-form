import { Schema, SchemaTypes, VueJsonSchemaConfig, Schemas } from './types'
...
export function optionsList(schema: Schemas): { key: any; value: any }[] {
  if (schema.enum) {
...
export function resolveSchema(schema: Schemas, rootSchema = {}, formData = {}) {
...
export function findSchemaDefinition($ref: string, rootSchema = {}): Schemas {
  const origRef = $ref
  if ($ref.startsWith('#')) {
...
export function getSchemaType(schema: Schemas): string | undefined {
  let { type } = schema
...
export function isConstant(schema: Schemas) {
  return (
...
export function isSelect(_schema: any, rootSchema: Schemas = {}) {
...
export function isMultiSelect(schema: Schemas, rootSchema: Schemas = {}) {
...
export function getMatchingOption(
  formData: any,
  options: Schemas[],
  isValid: (schema: Schemas, data: any) => boolean,
) {
